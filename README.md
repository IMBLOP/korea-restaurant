...
1. 전체 데이터(2,163,574건) 중 폐업한 음식점들의 데이터 drop -> 현재 영업중인 음식점 데이터 추출
2. 전체 Column 중 필요한 Column의 데이터만 추출 (697,989건)
...
---
## 결론
__지역별 음식점 분포를 분석한 결과, 한식이 대부분의 지역에서 높은 비중을 차지하며, 대도시일수록 음식점 수와 업종의 다양성이 두드러지는 경향을 확인할 수 있었습니다.__
